    ...
    <main>
        ...
        <div class="container mt-4">
            <div class="form-container">
                <h2 class="mb-4">Edit Concert Details</h2>
                <form action="updateConcert.php" method="POST">
                    <div class="form-group">
                        <label for="venue">Venue</label>
                        <select class="form-control" id="venue" name="venue" required>
                            <option value="Venue A" selected>Venue A</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="Rock Concert" required>
                    </div>

                    <div class="form-group">
                        <label for="totalSlot">Total Slots</label>
                        <input type="number" class="form-control" id="totalSlot" name="totalSlot" value="200" required>
                    </div>

                    <div class="form-group">
                        <label for="date">Date</label>
                        <input type="date" class="form-control" id="date" name="date" value="2024-12-25" required>
                    </div>

                    <div class="form-group">
                        <label for="percentagePerSlot">Revenue Percentage Per Ticket Sale</label>
                        <input type="number" class="form-control" id="percentagePerSlot" name="percentagePerSlot" value="80" required>
