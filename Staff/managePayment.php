...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <nav class="col-md-2 sidebar">
                ...
                <a href="managePayment.html" class="active"><i class="bi bi-cash-stack"></i> Payment Management</a>
            </nav>
        </div>
    </div>
    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>5000</td>
                        <td>
                            <a href="editPayment.html" class="btn btn-warning btn-sm">Edit</a>
                            <a href="deletePayment.html" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
            ...
            <div class="mt-4">
                <a href="addPayment.html" class="btn btn-success">Add New Payment</a>
            </div>
        </div>
    </main>
