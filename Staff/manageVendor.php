...
<body>
    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="editVendor.html" class="btn btn-warning btn-sm">Edit</a>
                            <a href="deleteVendor.html" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
            ...
            <div class="mt-4">
                <a href="addVendor.html" class="btn btn-success">Add New Vendor</a>
            </div>
        </div>
    </main>
