...
<body>
    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <h2 class="mb-4">Enter Vendor Information</h2>
            <form action="submit-new-vendor.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="shortOffer" placeholder="Enter short offer">
                </div>
                <div class="form-group">
                    <label for="details">Detailed Offer</label>
                    <textarea class="form-control" id="details" rows="4" placeholder="Enter detailed offer description"></textarea>
                </div>
                    <button type="submit" class="btn btn-success">Add Vendor</button>
                    <a href="manageVendor.html" class="btn btn-secondary ml-2">Cancel</a>
                </div>
            </form>
        </div>
    </div>
