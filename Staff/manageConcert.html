...
<body>
    ...
    <main>
        ...
        <div class="container mt-4">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Active</td>
                        <td>
                            <a href="editConcert.html" class="btn btn-warning btn-sm">Edit</a>
                            <a href="deleteStaff.html" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
            ...
            <div class="mt-4">
                <a href="AddConcert.html" class="btn btn-success">Add New Concert</a>
            </div>
        </div>
    </main>
